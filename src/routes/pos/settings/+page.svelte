<script lang='ts'>
    ...
    import ThemeSwitcher from '../../ThemeSwitcher.svelte'; // <-- CORRECTED PATH
        ...
        if (file) {
            ...
            reader.onload = (e) => {
                try {
                    ...
                    savedCarts.set(importedData.savedCarts || []);
...
<input id="tax-rate-input" type="number" 
                    ...
                    <div id="tour-settings-stripe">
                        ...
                        <h2 class="card-title 
        text-xl font-greycliffmed mb-4">Stripe Payments</h2>
