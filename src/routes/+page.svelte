...
<div class="flex flex-col min-h-screen">
    <main class="flex-grow flex flex-col items-center justify-center p-4">
        ...
        <div class="text-center mb-8">
            ...
            <p class="font-greycliffmed text-lg text-gray-500 mt-2">Create a Point-of-Sale terminal instantly.</p>
        </div>
        ...
        <div class="card w-full max-w-md bg-base-100 shadow-xl border border-gray-200">
            ...
            <div class="card-body p-8">
                ...
                <div class="card-actions justify-center mt-6">
                    <button on:click={createStore} class="btn btn-primary btn-wide text-white font-greycliffbold normal-case">Create Store</button>
                </div>
