...
const updateNotes = [
// ... (omitting existing updateNotes for brevity)
    ];
</script>
            ...
            <main class="lg:col-span-3 space-y-8">
                ...
                <div id="getting-started" class="card bg-base-100 shadow-xl border">
                    <div class="card-body">
                        ...
                        <p class="mt-4">Follow this detailed, step-by-step guide to take your store from zero to fully operational in just a few minutes.
                        </p>
                        ...
                        <ul class="timeline timeline-vertical mt-6">
                            ...
                            <li>
                                ...
                                <div class="timeline-middle">
                                    ...
                                    fill="currentColor" class="w-5 h-5 text-primary"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.06 0l4.25-5.832z" clip-rule="evenodd" /></svg>
                                </div>
                                <div class="timeline-end timeline-box">
                ...
                <div id="feature-guide" class="card bg-base-100 shadow-xl border">
                    <div class="card-body">
                        <h2 class="card-title text-2xl font-greycliffmed">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 
                                6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" /></svg>
                ...
                <div id="data-security" class="card bg-base-100 shadow-xl border">
                    ...
                    <div class="card-body">
                        <h2 class="card-title text-2xl font-greycliffmed">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.944a11.955 11.955 0 018.618-3.04 11.955 11.955 0 018.618 3.04 12.02 12.02 0 
                                00-3-8.984z" /></svg>
