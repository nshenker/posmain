            ...
            <div class="fixed top-0 left-0 right-0 z-50 bg-base-100 shadow-md no-print">
                <div class="navbar px-4">
                    ...
                    <div class="navbar-end">
                        <ThemeSwitcher />
                        <!-- 
                          FIX: Changed the on:click handler to an arrow function. 
                          This ensures the correct function (onExit or onRequest) is called based on the current $fullScreen state when the button is clicked.
                        -->
