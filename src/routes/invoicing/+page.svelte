<script lang='ts'>
    ...
    function saveInvoice() {
        if (!currentInvoice.customerName.trim()) { if (browser) showToast('Please enter a customer name.', 'error');
            return; }
    ...
    async function checkInvoicePayments() {
        ...
        const invoicesToCheck = $invoices.filter(inv => inv.status !== 'Paid');

        for (const invoice of invoicesToCheck) {
            if (dayjs().isAfter(dayjs(invoice.dueDate))) {
...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="no-print space-y-6">
            <div class="card bg-base-100 shadow-xl border"><div class="card-body p-6">
                ...
                <div class="form-control">
                    <label class="label" for="payment-currency"><span class="label-text">Payment 
                    Currency</span></label>
            ...
            <div class="mt-6 flex flex-wrap gap-4 justify-center">
                ...
                btn-wide" on:click={saveInvoice}>Save Invoice</button>
    ...
    <div class="card w-full bg-base-100 shadow-xl border mt-8 no-print"><div class="card-body p-6">
        <h2 class="card-title 
        text-xl font-greycliffmed">Saved Invoices</h2>
                ...
                <tbody>
                    ...
                    <tr class="hover">
                        ...
                        <td class="space-x-1">
                            ...
                            <button class="btn btn-xs btn-outline btn-success" on:click={() => markAsComplete(invoice.id)}>Complete</button>
