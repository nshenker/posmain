<script lang='ts'>
    ...
    import { triggerInvoicePrint } from '../printStore.js'; // NEW: Import the print utility
    ...
    // NEW FUNCTION: Triggers browser print for the invoice preview area
    function printInvoice() {
        if (typeof window === 'undefined') return;

        // Ensure currentInvoice details are up-to-date
        const finalInvoice = { 
            ...currentInvoice, 
            total: subtotal + taxAmount,
        };
        
        // Use the new print utility function
        triggerInvoicePrint(finalInvoice, get(storeName), get(businessAddress));
    }
    ...
    function generateQrCode() {
        ...
        // --- FIXED: Save reference to the currentInvoice object ---
...
<div class="modal modal-open">
    <div class="modal-box w-11/12 max-w-7xl">
        ...
        <div class="modal-action">
            ...
            <button type="button" 
            class="btn btn-info" on:click={printInvoice}>Print Invoice</button>
